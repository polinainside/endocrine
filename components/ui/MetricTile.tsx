...
export function MetricTile({
  ...
  return (
    <div className="flex flex-1 flex-col gap-1.5 rounded-card border border-border bg-surface p-3 shadow-card">
      <Icon className="h-4 w-4 text-brand" strokeWidth={2.2} />
      <span className="text-[17px] font-semibold leading-tight text-ink">{value}</span>
